from api.pipelines.infer_identity_flavor import derive_role_constraints, infer_job_and_role, infer_flavor_text
from api.app.models.character_models import CharacterCardResponse, Identity, StatBar, UIStats
from api.app.services.input_adapter import InputAdapter
from api.app.services.stat_calculator import (
    calculate_stats,
...
class CharacterGenerator:
    ...
    def generate(self, raw_input: dict) -> CharacterCardResponse:
        ...
        if self.use_llm:
            ...
            job_title = identity_data.get("job_title") or "모험가"
            role = identity_data.get("role") or "방랑자"
