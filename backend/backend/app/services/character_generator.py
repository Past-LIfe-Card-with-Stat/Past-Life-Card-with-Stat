from backend.pipelines.infer_identity_flavor import derive_role_constraints, infer_job_and_role, infer_flavor_text
...
from backend.app.services.stat_calculator import (
    calculate_stats,
